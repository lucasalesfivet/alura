        ...
        <article class="card_vendas-dash1">
            ...
            <article class="card_vendas-dash4">
                <div class="card-texto-resumo">
                    ...
                    <h3 class="card-titulo2-resumo">
                        <?php
                            $sql = ("SELECT count(*) NUMNOTA FROM pcnfsaid WHERE dtfat BETWEEN '01-fev-2023' AND '28-fev-2023' and codcob <> 'BNF'");
            ...
            <article class="card_vendas-dash5">
                <div class="card-texto-resumo">
                    ...
                    <h3 class="card-titulo2-resumo">
                        <?php
                            $sql = ("SELECT count(*) NUMNOTA FROM pcnfsaid WHERE dtfat BETWEEN '01-mar-2022' AND '31-mar-2022' and codcob <> 'BNF'");
            ...
            <article class="card_vendas-dash7">
                <div class="card-texto-resumo">
                    ...
                    <h3 class="card-titulo2-resumo">
                    <?php
                            $sql = ("SELECT TO_CHAR((SELECT round(SUM(vltotal)) as FATANTERIOR FROM pcnfsaid where dtfat between '01-fev-2023' and '28-fev-2023' and codcob <> 'BNF'),'FM999G999G999G999') as VALOR FROM PCNFSAID where rownum = 1");
            ...
            <article class="card_vendas-dash8">
                <div class="card-texto-resumo">
                    ...
                    <h3 class="card-titulo2-resumo">
                        <?php
                            $sql = ("SELECT TO_CHAR((SELECT round(SUM(vltotal)) as FATANTERIOR FROM pcnfsaid where dtfat between '01-mar-2022' and '31-mar-2022' and codcob <> 'BNF'),'FM999G999G999G999') as VALOR FROM PCNFSAID where rownum = 1");
